...
#define STRING_CONFIG_H_AUTHOR "(rcvn, frankenz config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "FrankenZ"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 160, 400, 420 }
